  ...
  return {
    ...
    server: {
      ...
      headers: {
        ...
        'Permissions-Policy': 'accelerometer=*, camera=(self), microphone=(self), geolocation=(self)',
        'Access-Control-Expose-Headers': 'x-rtb-fingerprint-id, request-id',
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, x-rtb-fingerprint-id, request-id',
