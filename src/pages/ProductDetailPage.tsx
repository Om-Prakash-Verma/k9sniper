      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-square rounded-[4rem] overflow-hidden shadow-2xl border border-brand-accent-secondary/10 bg-brand-bg-secondary">
              <img 
          ...
          >
            ...
            <div className="text-4xl font-display font-bold text-brand-accent mb-12">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <div className="px-6 py-3 bg-brand-bg-secondary rounded-2xl border border-brand-accent-secondary/10 flex items-center gap-3">
                ...
                <span className="text-brand-primary font-bold uppercase tracking-widest text-[10px]">
                  {selectedVariation ? `${selectedVariation.stock} In Stock` : (product.stock > 0 ? 'In Stock' : 'Out of Stock')}
                </span>
              </div>
              <div className="px-6 py-3 bg-brand-bg-secondary rounded-2xl border border-brand-accent-secondary/10 flex items-center gap-3">
                <ShieldCheck className="w-5 h-5 text-brand-accent" />
                <span className="text-brand-primary font-bold uppercase tracking-widest text-[10px]">Quality Guaranteed</span>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-12">
              {product.specifications && (
                <div className="p-6 bg-brand-bg-secondary rounded-3xl border border-brand-accent-secondary/10">
                  <h4 className="text-brand-primary font-bold uppercase tracking-widest text-xs mb-2">Specifications</h4>
                  <p className="text-brand-text/60 text-sm whitespace-pre-wrap">{product.specifications}</p>
                </div>
              )}
              {product.ingredients && (
                <div className="p-6 bg-brand-bg-secondary rounded-3xl border border-brand-accent-secondary/10">
                  <h4 className="text-brand-primary font-bold uppercase tracking-widest text-xs mb-2">Ingredients</h4>
                  <p className="text-brand-text/60 text-sm whitespace-pre-wrap">{product.ingredients}</p>
                </div>
              )}
              {product.usageInstructions && (
                <div className="p-6 bg-brand-bg-secondary rounded-3xl border border-brand-accent-secondary/10">
                  <h4 className="text-brand-primary font-bold uppercase tracking-widest text-xs mb-2">Usage Instructions</h4>
                  <p className="text-brand-text/60 text-sm whitespace-pre-wrap">{product.usageInstructions}</p>
                </div>
              )}
            </div>
