  ...
  if (error && pets.length === 0) {
    return (
      <div className="min-h-screen bg-brand-bg pt-32 px-4 flex items-center justify-center">
        <SEO 
          title="Pets for Sale | K9 Sniper"
          description="Browse our collection of premium pets for sale. From loyal dogs to beautiful birds, find your perfect companion at K9 Sniper."
        />
