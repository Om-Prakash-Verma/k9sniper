        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group p-8 rounded-3xl bg-brand-bg-secondary border border-white/5 hover:border-brand-accent/20 transition-all duration-500 relative overflow-hidden"
            >
              ...
              <h4 className="text-lg font-bold text-white leading-tight group-hover:text-brand-accent transition-colors duration-500">
                {reason.title}
              </h4>
