...
const About = () => {
  return (
    <section id="overview" className="py-24 md:py-32 bg-brand-bg-secondary overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-lg md:text-xl text-text-body leading-relaxed">
              <p>
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 aspect-[4/5] lg:aspect-square">
              <img 
